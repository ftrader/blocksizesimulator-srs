...
Using a simplified model of a network comprising constrained but upgradeable
mining and service nodes, and `legitimate' versus `spam' transactions,
the simulator is intended to answer information on the following observables:

\begin{itemize}  
\item network splitting
\item node downtime (both service and mining); in context of upgrade feasibility
\item transaction delays in face of full blocks whether from legit or spam traffic
...
$<$Note: A simple diagram that shows the major components of the overall system,
...
Initially, the simulator user interface will be via command line input output and text files
read from and/or written to disk.
