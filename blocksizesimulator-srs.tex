...
These shall be positive real numbers value expressing increase in
transactions per second per second.

The increase shall only apply to the spike peak level and not the duration or
any other time-related parameters.
