...
attributes, but have the additional capability to produce blocks.
...
\item Aggregate delay for "legit" transactions: # transaction x number of blocks before inclusion
\item Aggregate time where > 50% mempool is desynchronized
