...
\hypersetup{
    ...
    pdftitle={Adjustable Blocksize Limit Scenario Simulator SRS},    % title
    pdfauthor={various},                     % author
    pdfsubject={Software Requirements Specification},                % subject of the document
    pdfkeywords={Bitcoin, simulator, blocksize, adaptive, dynamic, requirements}, % list of keywords
...
\begin{center}
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
	    imaginary_username & 2019-05-23 & small clarifications & 0.1.1 \\
        \hline
	    freetrader & 2019-05-23 & format, PDF info updates & 0.1.2 \\
        \hline
    \end{tabular}
\end{center}
